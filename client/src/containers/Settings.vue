...
const uploadProfileMedia = async (file: File, isProfilePic: boolean = true) => {
  ...
  <div class="max-h-svh overflow-auto">
    <div class="w-full flex flex-col items-center">
      <div class="w-full h-40 mb-20 relative bg-slate-900">
        ...
        >
          <span class="text-xl font-semibold text-color-white">Settings</span>
          <label
        ...
        >
          <div class="w-full h-full relative">
            ...
            <div
              v-else
              class="w-full h-full flex items-center justify-center relative delay-300 hover:-z-10"
      ...
      <div class="w-full mt-2 mb-10 flex flex-col items-center">
        ...
        <span class="flex items-center text-xs font-medium"
          ><small class="w-2 h-2 mr-1 block bg-green-500 rounded-full"></small
          >Active</span
        >
      </div>
      <div class="w-full">
        <div class="border-y border-y-color-background-mute">
          ...
          >
            <span class="w-auto flex"
              ...
              <p class="ml-2 text-xs font-semibold">Personal Info</p></span
            >
            <span
              class="duration-200"
        ...
        <div class="border-y border-y-color-background-mute">
          ...
          >
            <span class="w-auto flex"
              ...
              <p class="ml-2 text-xs font-semibold">Privacy</p></span
            >
            <span
              class="duration-200"
